...
{
    //macros can also be defined inside functions
    //note the name returned by this must be passed through c++filt
#define print_type( type ) \
std::cout<<"\ttypeof( "<<#type<<") is "<<typeid(type).name()<<std::endl 

    //Here are some examples of different ways to assign variables.
